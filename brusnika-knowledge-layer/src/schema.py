...
class ChunkPayload(BaseModel):
    ...
    header_1: Optional[str] = Field(default=None, description="Заголовок H1 верхнего уровня")
    header_2: Optional[str] = Field(default=None, description="Заголовок H2")
    header_3: Optional[str] = Field(default=None, description="Заголовок H3")
    ...
    parent_id: Optional[str] = Field(default=None, description="ID сырой Markdown-таблицы (если chunk_type == 'table_summary')")