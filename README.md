...
Корпоративный ИИ-ассистент (RAG-система) для компании. Система предназначена для поиска и агрегации информации по внутренней базе знаний (регламенты, процессы, стандарты) с учетом уровней доступа пользователей и мультидоменной архитектуры.
